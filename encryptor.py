...
def encrypt(file_location: str, salt_str: str, unique_number_range: int, iteration: int):
    with open(file_location, "r", encoding="utf-8") as f:
        ...
        for i in line_list:
            ...
            output.append(encryption_target)
        with open("output.txt", "w") as outfile:
            outfile.write("\n".join(output))


if __name__ == '__main__':
    encrypt(sys.argv[1], sys.argv[2], int(sys.argv[3]), int(sys.argv[4]))
